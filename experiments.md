...
|Q28| SELECT ?name ?work ?title WHERE {<br>(tp1): ?artist dbpedia-owl:movement<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ?movement . <br>(tp2): ?movement rdfs:label<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"Cubism"@en . <br>(tp3): ?artist foaf:name ?name . <br>(tp4): ?work schema:author ?author . <br>(tp5): ?author schema:sameAs ?artist . <br>(tp6): ?work schema:name ?title <br>   FILTER (!REGEX(?name, ",")) <br>} |EXCLUDED|  |   |
